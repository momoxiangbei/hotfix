...
public class MethodUtils {
    ...
    public static Object invokeDeclaredMethod(final Object object, final String methodName, Object... args) throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        final Class<?>[] parameterTypes = Utils.toClass(args);
        args = Utils.nullToEmpty(args);
        return invokeDeclaredMethod(object, methodName, args, parameterTypes);
    }
